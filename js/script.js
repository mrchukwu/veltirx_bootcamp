...
function initiatePayment() {
    ...
    const handler = PaystackPop.setup({
        ...
        onClose: function() {
            ...
            showNotification('Payment cancelled. You can try again when ready.', 'info');
        }
    });
...
function handlePaymentSuccess(response) {
    ...
    showNotification('Payment successful! Welcome to JavaScript Mastery Bootcamp!', 'success');
...
function playVideo() {
    ...
    showNotification('Video demo coming soon! Contact us for a live demo.', 'info');
}
...
function initAnimationsOnScroll() {
    ...
    document.querySelectorAll('.benefit-card, .instructor-card, .module-card, .timeline-item, .project-card').forEach(el => {
        observer.observe(el);
    });
